...
public class CustomerRepository implements JdbcRepository {
    ...
    public List<Customer> findAll() {
        ...
        // return jdbcTemplate.query(query, new CustomerMapper()); รีเทิร์น แบบนี้เลยก็ได้ ไม่ต้องเก็บค่าในตัวแปล customer
    }
    ...
    public Customer findById(int id) {
        ...
        return customer;
        // return jdbcTemplate.queryForObject(query, new CustomerMapper()); รีเทิร์น แบบนี้เลยก็ได้ ไม่ต้องเก็บค่าในตัวแปล customer
    }
